...
$page_title = 'About | Armadio';
$page_description = 'Armadio is a unified trading platform connecting wholesale buyers, retail shoppers and vetted brands under one roof.';
require __DIR__ . '/includes/header.php';

$values = [
    [
        'title' => 'One network, two markets',
        'description' => 'We built Armadio so a single sourcing relationship can serve both a trade account and a retail storefront — no duplicated effort.',
    ],
    [
        'title' => 'Vetted, not just listed',
        'description' => 'Every brand on Armadio passes a quality and compliance review before it reaches buyers or shoppers.',
    ],
    [
...
<?= render_page_header('About Armadio', 'Trading, made for both sides of the counter', "Armadio started with a simple observation: wholesale buyers and retail shoppers often want the same brands — just in different quantities. So we built one platform for both.", 'assets/images/photos/hero-about.jpg') ?>

<section class="section bg-ivory">
  <div class="container" style="max-width: 56rem;">
    <div class="reveal">
      <?= render_section_heading('Our Story', "Built by people who've sat on both sides of a purchase order", "Our founding team spent years sourcing for independent retailers and negotiating wholesale terms for growing brands. Armadio exists to remove the friction between the two — one sourcing pipeline, one quality bar, two ways to buy.") ?>
    </div>
...
<section class="section bg-ivory">
  <div class="container" style="max-width: 56rem; text-align: center;">
    <div class="reveal">
      <h2 style="font-family: var(--font-display); font-size: 1.875rem; font-weight: 500; color: var(--color-navy);">Curious how Armadio could work for you?</h2>
