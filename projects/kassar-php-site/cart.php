...
<?= render_page_header('B2C Retail', 'Your Cart', 'Review your items below, then check out securely with Stripe.') ?>
  ...
  <div class="container" style="max-width: 72rem;" data-cart-root>
    ...
    <div class="cart-layout" data-cart-filled hidden>
      ...
      <div class="cart-summary">
        ...
        <p class="cart-checkout-error" data-cart-error hidden></p>
